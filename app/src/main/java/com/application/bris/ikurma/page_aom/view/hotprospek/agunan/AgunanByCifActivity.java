...
public class AgunanByCifActivity extends AppCompatActivity implements AgunanListener, AgunanByCifListener {
    ...
    private ListInfo dataInfo=new ListInfo();
                    ...
                    if (response.isSuccessful()) {
                        if (response.body().getStatus().equalsIgnoreCase("00")) {
                            ...
                            try {
                                ...
                                AppUtil.logSecure("ERROR_DATA_INFO","dataInfo is NULL");
                                dataInfo.setLOAN_TYPE(appPreferences.getLoanType());

                                //tp produk dipantek 20 karena mikro
                                dataInfo.setFID_TP_PRODUK(20);
                            }
                            catch (IndexOutOfBoundsException e){
                                AppUtil.logSecure("ERROR_DATA_INFO","dataInfo index out of bounds");
                                dataInfo.setLOAN_TYPE(appPreferences.getLoanType());
    ...
    public void initializeKendaraan(){
        adapterListKendaraan = new FrontAgunanKendaraanByCifAdapater(AgunanByCifActivity.this, dataKendaraan, AgunanByCifActivity.this, idAplikasi, idCif);
        layoutKendaraan = new LinearLayoutManager(AgunanByCifActivity.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    public void initializeKios(){
        adapterListKios = new FrontAgunanKiosByCifAdapater(AgunanByCifActivity.this, dataKios, AgunanByCifActivity.this, idAplikasi, idCif);
        layoutKios = new LinearLayoutManager(AgunanByCifActivity.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    public void initializeDeposito(){
        adapterListDeposito = new FrontAgunanDepositoByCifAdapater(AgunanByCifActivity.this, dataDeposito, AgunanByCifActivity.this, idAplikasi, idCif);
        layoutDeposito = new LinearLayoutManager(AgunanByCifActivity.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    public void onSelectMenuAgunan(String idMenu) {
        switch (idMenu) {
            ...
            case "AgunanTanahBangunan Kendaraan":
                Intent itKendaraan=new Intent(AgunanByCifActivity.this, AgunanKendaraanInputActivity.class);
            ...
            case "AgunanTanahBangunan Kios":
                Intent itKios=new Intent(AgunanByCifActivity.this, AgunanKiosInputActivity.class);
            ...
            case "AgunanTanahBangunan Deposito":
                Intent itDeposito=new Intent(AgunanByCifActivity.this, AgunanDepositoInputActivity.class);
