...
public class SubmenuHotprospekKmgAdapter extends RecyclerView.Adapter<SubmenuHotprospekKmgAdapter.MenuViewHolder> {
    ...
    public SubmenuHotprospekKmgAdapter(Context context, List<ListViewSubmenuHotprospek> menu, hotprospekKmg mdata, MenuClickListener menuClickListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SubmenuHotprospekKmgAdapter.MenuViewHolder holder, final int position) {
