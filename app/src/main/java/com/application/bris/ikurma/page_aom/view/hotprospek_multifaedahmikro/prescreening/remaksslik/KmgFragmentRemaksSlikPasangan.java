...
public class KmgFragmentRemaksSlikPasangan extends Fragment implements SlikListener{
    ...
    private KmgRemaksSlikAdapater adp = null;

    public KmgFragmentRemaksSlikPasangan(){
