...
import com.application.bris.ikurma.adapter.menu.SubmenuApprovedKmgAdapter;
...
public class KmgApprovedDetailActivity extends AppCompatActivity implements MenuClickListener{
    ...
    private SubmenuApprovedKmgAdapter submenuHotprospekAdapter;
   ...
   @Override
    ...
    private void loadDataHotprospek() {
        ...
        call.enqueue(new Callback<ParseResponse>() {
                ...
                try {
                    if (response.isSuccessful()){
                        if(response.body().getStatus().equalsIgnoreCase("00"))
                        {
                            ...
                            Glide
                                    .with(KmgApprovedDetailActivity.this)
                                    .asBitmap()
                                    .load(url_photo)
                            ...
                            AppUtil.notiferror(KmgApprovedDetailActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                        ...
                        AppUtil.notiferror(KmgApprovedDetailActivity.this, findViewById(android.R.id.content), error.getMessage());
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                finish();
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                AppUtil.notiferror(KmgApprovedDetailActivity.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        finish();
    ...
    public void initializeMenu(){
        ...
        submenuHotprospekAdapter = new SubmenuApprovedKmgAdapter(this, dataMenu, dataHp,this);
