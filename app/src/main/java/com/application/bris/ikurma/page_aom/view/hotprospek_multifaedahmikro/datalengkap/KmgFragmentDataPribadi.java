...
public class KmgFragmentDataPribadi extends Fragment implements Step, KeyValueListener, View.OnClickListener, View.OnFocusChangeListener {
...
//    }
    ...
    public KmgFragmentDataPribadi(DataLengkapKmg mdataLengkap, String maprroved) {
        dataLengkap = mdataLengkap;
        approved = maprroved;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.ao_fragment_datapribadi_kmg, container, false);
...
//        et_namaibukandung.setFocusable(false);
    ...
    private VerificationError validateForm() {
        ...
        } else if (!Validator.validateNpwpRequired(KmgDataLengkapActivity.plafond >= Constants.VALIDATE_PLAFOND_NPWP, et_npwp.getText().toString().trim())) {
        ...
        KmgDataLengkapPojo nikPasangan = realm.where(KmgDataLengkapPojo.class).equalTo("noKtpPasangan", et_nikpasangan.getText().toString()).findFirst();
...
//        d.setUid(7983);
        ...
        KmgDataLengkapPojo d = realm.where(KmgDataLengkapPojo.class).equalTo("idAplikasi", KmgDataLengkapActivity.idAplikasi).findFirst();
        KmgDataLengkapPojo copyRealm = new KmgDataLengkapPojo();
...
//            realm.beginTransaction();
            copyRealm.setIdAplikasi(KmgDataLengkapActivity.idAplikasi);
        }


        copyRealm.setCif(KmgDataLengkapActivity.cif);
        copyRealm.setUid(KmgDataLengkapActivity.uid);
