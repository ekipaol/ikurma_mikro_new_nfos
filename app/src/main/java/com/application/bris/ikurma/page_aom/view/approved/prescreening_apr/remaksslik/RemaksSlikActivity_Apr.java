...
public class RemaksSlikActivity_Apr extends AppCompatActivity{
    ...
    private void loadData() {
        ...
        call.enqueue(new Callback<ParseResponse>() {
                ...
                try {
                    if (response.isSuccessful()){
                        if (response.body().getStatus().equalsIgnoreCase("00")){
                            ...
                            AppUtil.notiferror(RemaksSlikActivity_Apr.this, findViewById(android.R.id.content), response.body().getMessage());
                            finish();
                        }
                    }
                    else {
                        Error error = ParseResponseError.confirmEror(response.errorBody());
                        AppUtil.notiferror(RemaksSlikActivity_Apr.this, findViewById(android.R.id.content), error.getMessage());
                        finish();
                    }
                }
                catch (Exception e){
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                loading.setVisibility(View.GONE);
                AppUtil.notiferror(RemaksSlikActivity_Apr.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
                finish();
            }
        });
    ...
    class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (statusKawin == 2){
                switch (position){
                    case 0:
                        fr = new FragmentRemaksSlikNasabah_Apr();
                        bdl.putString("dataSlikNasabah", slikNasabahString);
                        fr.setArguments(bdl);
                        return fr;

                    case 1:
                        fr = new FragmentRemaksSlikPasangan_Apr();
