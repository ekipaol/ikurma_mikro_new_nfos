...
public class FragmentRemaksSlikPasangan_Apr extends Fragment implements SlikListener{
    ...
    private RemaksSlikAdapater_Apr adp = null;

    public FragmentRemaksSlikPasangan_Apr(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adp = new RemaksSlikAdapater_Apr(getContext(), data, this);
    ...
    public void onSelectSlik(List<ModelRemaksSlik> listData, ModelRemaksSlik data, int position) {
        ...
        Intent intent = new Intent(getContext(), RemaksSlikEditActivity_Apr.class);
