...
public class SetPengikatanActivity_Apr extends AppCompatActivity implements ConfirmListener {
                        ...
                        if(response.body().getStatus().equalsIgnoreCase("00")){
                            ...
                            call2.enqueue(new Callback<ParseResponseArr>() {
                                        ...
                                        if (response2.isSuccessful()){
                                            if(response2.body().getStatus().equalsIgnoreCase("00")){
                                                ...
                                                if (dataJenisKlasifikasi.size() > 0){
                                                    ...
                                                    adapterJenisPengikatan = new ArrayAdapter<String>(SetPengikatanActivity_Apr.this, R.layout.spinner_style, jenisPengikatanArray);
                                            ...
                                            AppUtil.notiferror(SetPengikatanActivity_Apr.this, findViewById(android.R.id.content), error.getMessage());
                                        }
                                    }
                                    catch (Exception e){
                                        e.printStackTrace();
                                ...
                                public void onFailure(Call<ParseResponseArr> call2, Throwable t) {
                                    AppUtil.notiferror(SetPengikatanActivity_Apr.this, findViewById(android.R.id.content), "Terjadi Kesalahan");
                                }
                            });
    ...
    private void buttonIkat(){
        ...
        if (et_no_bukti_pengikatan.getText().toString().isEmpty() || et_no_bukti_pengikatan.getText().toString().trim().equalsIgnoreCase("")){
            ...
            new AlertDialog.Builder(SetPengikatanActivity_Apr.this)
                    .setTitle("Ikat")
                    .setMessage("Apakah anda yakin ingin mengikat agunan?")
                    .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            final ProgressDialog loadingDialog = ProgressDialog.show(SetPengikatanActivity_Apr.this, "",
                                    "Memproses", true);
                                    ...
                                    try {
                                        if (response1.isSuccessful()){
                                            if(response1.body().getStatus().equalsIgnoreCase("00")){
                                                ...
                                                CustomDialog.DialogSuccess(SetPengikatanActivity_Apr.this, "Success!", "Berhasil Mengikat AgunanTanahBangunan", SetPengikatanActivity_Apr.this);
                                                Toast.makeText(SetPengikatanActivity_Apr.this, "Berhasil Mengikat Agunan", Toast.LENGTH_SHORT).show();
                                                Intent it = new Intent(SetPengikatanActivity_Apr.this, AgunanTerikatActivity_Apr.class);
                                                it.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                                                startActivity(it);
                                            } else {
                                                AppUtil.notiferror(SetPengikatanActivity_Apr.this, findViewById(android.R.id.content), response1.body().getMessage());
                                            }
                                        }
                                        else {
