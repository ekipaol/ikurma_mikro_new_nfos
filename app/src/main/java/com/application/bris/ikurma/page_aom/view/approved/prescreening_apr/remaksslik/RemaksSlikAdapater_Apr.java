...
public class RemaksSlikAdapater_Apr extends RecyclerView.Adapter<RemaksSlikAdapater_Apr.TlViewHolder>{
    ...
    public RemaksSlikAdapater_Apr(Context context, List<ModelRemaksSlik> mdata, SlikListener slikListener) {
    ...
    public TlViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RemaksSlikAdapater_Apr.TlViewHolder(view, viewType);
    }
    ...
    public void onBindViewHolder(@NonNull final TlViewHolder holder, final int position) {
        ...
        holder.cv_remaks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppUtil.showToastShort(context, "Angsuran tidak bisa diRemarks karna aplikasi sudah Approved");
            }
        });
