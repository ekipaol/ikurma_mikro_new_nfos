...
public class AgunanTanahBangunanInputActivity_Apr extends AppCompatActivity implements StepperLayout.StepperListener, OnNavigationBarListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiClientAdapter = new ApiClientAdapter(AgunanTanahBangunanInputActivity_Apr.this);
        appPreferences = new AppPreferences(this);
        backgroundStatusBar();
        AppUtil.toolbarRegular(AgunanTanahBangunanInputActivity_Apr.this, "Agunan Tanah Bangunan");
        ...
        if (!idAgunan.equalsIgnoreCase("0")) {
            ...
            stepperlayout.setAdapter(new StepAdapterAgunan_Apr(getSupportFragmentManager(), AgunanTanahBangunanInputActivity_Apr.this, dataAgunan, idAgunan, loan_type, tp_produk), startingStepPosition );
            stepperlayout.setListener(AgunanTanahBangunanInputActivity_Apr.this);
        }
    }
    private void getData() {
        ...
        call.enqueue(new Callback<ParseResponse>() {
                ...
                try {
                    ...
                    if(response.isSuccessful()){
                        if(response.body().getStatus().equalsIgnoreCase("00")){
                            ...
                            AppUtil.notiferror(AgunanTanahBangunanInputActivity_Apr.this, findViewById(android.R.id.content), response.body().getMessage());
                        }
                    }
                    else{
                        Error error = ParseResponseError.confirmEror(response.errorBody());
                        AppUtil.notiferror(AgunanTanahBangunanInputActivity_Apr.this, findViewById(android.R.id.content), error.getMessage());
                    }
                }
                catch (Exception e){
                    e.printStackTrace();
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                loading.setVisibility(View.GONE);
                AppUtil.notiferror(AgunanTanahBangunanInputActivity_Apr.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
            }
        });
    }
