...
public class DataPrescreeningKmg {
    ...
    public DataPrescreeningKmg(Integer iDPRESCREENING, Boolean dUKCAPIL, Boolean dHN, Boolean sLIK, Boolean sIKP, String rESULT, Integer fIDAPLIKASI, String sTATUSKAWIN) {
