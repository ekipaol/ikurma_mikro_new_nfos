package com.application.bris.ikurma.page_aom.view.approved.rpc_apr;
...
public class RpcActivity_Apr extends AppCompatActivity{
                ...
                try {
                    if (response.isSuccessful()){
                        if(response.body().getStatus().equalsIgnoreCase("00")){
                            ...
                            tv_rpcratio.setText(String.valueOf(data.getRpcRatio())+" %");
...
//                                ll_info.setVisibility(View.VISIBLE);
                        ...
                        AppUtil.notiferror(RpcActivity_Apr.this, findViewById(android.R.id.content), error.getMessage());
                    }
                }
                catch (Exception e){
                    e.printStackTrace();
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                AppUtil.notiferror(RpcActivity_Apr.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
            }
        });
    }
}
