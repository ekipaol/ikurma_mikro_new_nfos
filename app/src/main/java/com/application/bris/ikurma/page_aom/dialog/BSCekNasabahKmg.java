...
import com.application.bris.ikurma.page_aom.view.pipeline_multifaedahmikro.KmgCeknasabahActivity;
...
public class BSCekNasabahKmg extends BottomSheetDialogFragment implements View.OnClickListener{
    ...
    public static BSCekNasabahKmg display(FragmentManager fragmentManager){
        BSCekNasabahKmg BSCekNasabah = new BSCekNasabahKmg();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_inquiry :
                if(validateInquiry()){
                    Intent it = new Intent(getContext(), KmgCeknasabahActivity.class);
